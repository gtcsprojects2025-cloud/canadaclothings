...
export default function MalePage() {
  ...
  const categories = Array.from(new Set(maleProducts.map(p => p.category)));
  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    return result;
  }, [maleProducts, selectedCategory, sortBy]);

  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Banner */}
      <div className="relative h-[420px] bg-black">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1505022610485-0249ba5b3675')] bg-cover bg-center opacity-75" />
        ...
        <div className="relative z-10 flex h-full items-center justify-center text-center px-6">
          <div>
            ...
            <p className="text-xl text-white/90 mt-4 max-w-2xl mx-auto">
              Modern, sharp, and comfortable styles for the contemporary man
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-xl text-gray-500">No men&apos;s products found.</p>
          </div>
        )}
      </div>
    </div>
